                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input class="form-control" type="text" placeholder="Nomor Surat" id="nomor_surat"
                                name="nomor_surat" value="<?php echo $pengajuan['nomor_surat']; ?>"> -->
                            <table style=" border:1px solid #fff;">
                                <tr>
                                    ...
                                    <td class="nomor_input"><input class="form-control" type="text"
                                            placeholder="Nomor Surat" id="nomor_surat" name="nomor_surat"
                                            value="<?php echo empty(set_value('nomor_surat')) ? $pengajuan['nomor_surat'] : set_value('nomor_surat'); ?>"
                                    ...
                                    <td class="nomor_input"><input class="form-control" type="text"
                                            ...
                                            value="<?php echo empty(set_value('kode_surat')) ? $kode_surat : set_value('kode_surat'); ?>">
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Kota Asal" id="kota_asal"
                                        name="kota_asal"
                                        value="<?php echo empty(set_value('kota_asal')) ? $pengajuan['kota_asal'] : set_value('kota_asal'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Keterangan" id="keterangan"
                                name="keterangan"
                                value="<?php echo empty(set_value('keterangan')) ? $pengajuan['keterangan'] : set_value('keterangan'); ?>">
                        </div>
