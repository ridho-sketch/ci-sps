                        ...
                        <form action="<?php echo site_url('SuratPengajuan/tambah_pengajuan'); ?>" method="post">
                            <div class="form-group">
                                ...
                                <table style=" border:1px solid #fff;">
                                    <tr>
                                        <td class="nomor_judul">
                                            <p>No.</p>
                                        </td>
                                        <td class="nomor_input"><input class="form-control" type="text"
                                                placeholder="Nomor Surat" id="nomor_surat" name="nomor_surat" value="<?php echo set_value('nomor_surat'); ?>" oninput="validateInput(event)">
                                        </td>
                                        <td class="nomor_judul">
                                            <p style="font-size:25px;">/</p>
                                        </td>
                                        <td class="nomor_input"><input class="form-control" type="text"
                                                placeholder="Kode Surat" id="kode_surat" name="kode_surat"
                                                value="<?php echo empty(set_value('kode_surat')) ? $nomor_surat : set_value('kode_surat'); ?>">
                                        </td>
                                    </tr>
                                </table>
                                <?php echo form_error('kode_surat', '<div class="text-danger" style="text-align:right; margin-right:145px;">', '</div>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="id_karyawan" class="col-form-label">Nama Karyawan<span
                                        class="required">*</span></label>
                                <select class="js-example-basic-single" name="id_karyawan">
                                    <option selected disabled>Pilih Karyawan</option>
                                    <?php foreach ($karyawan as $row): ?>
                                        <option value="<?php echo $row['id_karyawan']; ?>" <?php echo set_select('id_karyawan', $row['id_karyawan']); ?>>
                                            <?php echo $row['nama']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" style="border-radius: 15px;"
                                            name="jenis_pengajuan" data-minimum-results-for-search="Infinity">
                                            <option selected disabled>Pilih Tujuan Pengajuan</option>
                                            <option value="Dinas Dalam Negri" <?php echo set_select('jenis_pengajuan', 'Dinas Dalam Negri'); ?>>Dinas
                                                Dalam Negri</option>
                            ...
                            <div class="form-group" id="luarNegri" style="display:none;">
                                ...
                                <input class="form-control" type="text" name="kota_tujuan" id="kota_tujuan"
                                    placeholder="Kota Tujuan" value="<?php echo set_value('kota_tujuan'); ?>">
                                <?php echo form_error('kota_tujuan', '<div class="text-danger">', '</div>'); ?>
                            </div>
                            ...
                            <div class="row transparent-bg">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" style="border-radius: 15px;"
                                            ...
                                            <option value="Mobil" <?php echo set_select('kendaraan', 'Mobil'); ?>>
                                                Mobil</option>
                                            <option value="Kereta Api" <?php echo set_select('kendaraan', 'Kereta Api'); ?>>Kereta Api</option>
                                            <option value="Kapal" <?php echo set_select('kendaraan', 'DKapal'); ?>>
                                                Kapal
                                            </option>
                                            <option value="Pesawat" <?php echo set_select('kendaraan', 'Pesawat'); ?>>
                                                Pesawat</option>
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="penanggung_biaya" class="col-form-label">Penanggung
                                            Biaya<span class="required">*</span></label>
                                        <input class="form-control" type="text" placeholder="Penanggung Biaya"
                                            id="penanggung_biaya" name="penanggung_biaya"
                                            value="<?php echo set_value('penanggung_biaya'); ?>">
