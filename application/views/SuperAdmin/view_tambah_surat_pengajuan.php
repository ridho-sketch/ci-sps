        ...
        <div class="col-12 mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12">
                        <form action="<?php echo site_url('SuperAdmin/add_pengajuan'); ?>" method="post">
                            ...
                            <div class="col-12" style="text-align:center;">
                                <a href="<?php echo site_url('SuperAdmin/daftar_surat_pengajuan'); ?>"><button
                                        type="button" class="btn btn-secondary mb-3">Batal</button></a>
